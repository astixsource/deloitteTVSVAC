<%@ Page Title="" Language="VB" MasterPageFile="~/Data_Cohort3/MasterPage/Panel.master" AutoEventWireup="false" CodeFile="ExerciseMain.aspx.vb" Inherits="Set3_Main_frmExerciseMain_New" %>
        ...
        function fnOpenTest(RspID, ExerciseID, TotalTime, ExerciseType, LoginID) {
            ...
            if (ExerciseID == 1) {
               // window.location.href = "../CaseStudy/frmCaseStudy_Business1.aspx?MenuId=6" + "&RspID=" + RspID + "&ExerciseID=" + ExerciseID + "&ExerciseType=" + ExerciseType + "&TotalTime=" + TotalTime + "&intLoginID=" + LoginID
                ...
                window.location.href = "../Basket3/frmBasket_InstructionsMain.aspx?MenuId=6" + "&RspID=" + RspID + "&ExerciseID=" + ExerciseID + "&ExerciseType=" + ExerciseType + "&TotalTime=" + TotalTime + "&intLoginID=" + LoginID
            }
                ...
                window.location.href = "../CaseStudy/CaseStudyTechInstructions3.aspx?MenuId=6" + "&RspID=" + RspID + "&ExerciseID=" + ExerciseID + "&ExerciseType=" + ExerciseType + "&TotalTime=" + TotalTime + "&intLoginID=" + LoginID
            }
            else if (ExerciseID == 13) {
                window.location.href = "../TechnicalQuestionnaire/frmInstructions.aspx?MenuId=6" + "&RspID=" + RspID + "&ExerciseID=" + ExerciseID + "&ExerciseType=" + ExerciseType + "&TotalTime=" + TotalTime + "&intLoginID=" + LoginID
            }
