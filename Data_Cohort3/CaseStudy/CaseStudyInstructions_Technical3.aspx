<%@ Page Title="" Language="VB" MasterPageFile="~/Data_Cohort3/MasterPage/Site.master" AutoEventWireup="false" CodeFile="CaseStudyInstructions_Technical3.aspx.vb" Inherits="Set1_CaseStudy_CaseStudyInstructions" %>
    ...
    <script type="text/javascript">      
        function fnMSG() {
            ...
            var ExerciseID = '<%=ExerciseID%>'
             ...
             var RspID = '<%=RspID%>'
             window.location.href = "CaseStudy_Technical3.aspx?ExerciseID=" + ExerciseID + "&RspId=" + RspID + "&ExerciseType=" + ExerciseType + "&TimeAlloted=" + TimeAlloted;
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatter" runat="Server">
    ...
    <div class="row">
        ...
        <div class="title-line-center"></div>
                ...
                <p>
                    In Pune, a young and motivated first-generation entrepreneur has been appointed as the new TVS 
dealer. Pune is already a strong market for TVS, showing excellent performance across key parameters 
such as <strong>Net Promoter Score (NPS),</strong> service volume growth, market share, and brand equity. The 
company's ambition is to establish this dealership as a <strong>model dealership,</strong> setting benchmarks in 
customer experience, technical excellence, and dealership operations.
                </p>

                <p>
                    As the <strong>Territory Service Manager (TSM),</strong> you have been tasked with ensuring that the dealership 
achieves its potential. Your role includes supporting the dealer in recruiting and building a highperforming team, setting clear objectives, enhancing technical capabilities, and driving customer 
satisfaction while ensuring profitability and operational excellence.
                </p>
