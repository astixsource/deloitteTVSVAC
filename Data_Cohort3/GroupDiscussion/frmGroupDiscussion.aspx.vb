...
Imports System.Text
Partial Class frmGroupDiscussion
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack = True Then
            ...
            If dr.HasRows Then
                ...
                GradeId = IIf(IsDBNull(dr.Item("GradeId")), "1", dr.Item("GradeId"))
                'GradeId = IIf(IsDBNull(dr.Item("GD_Seq_No")), "0", dr.Item("GD_Seq_No"))
            End If
        End If
        ...
        If GradeId = 1 Then
            ...
            role_3.Visible = False
            role_4.Visible = False
            role_5.Visible = False
    ...
    Public Shared Function fnSubmit(ByVal ExerciseID As Integer, ByVal RSPExerciseID As Integer) As String
        ...
        fnUpdateActualStartEndTime(RSPExerciseID, 2, 3)   'Assessor Start

        fnUpdateActualStartEndTime(RSPExerciseID, 2, 4)   'Assessor End
