...
Partial Class SJT_frmSJTInstructions
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Dim BandID As String = IIf(IsNothing(Session("BandID")), "3", Convert.ToString(Session("BandID")))
        Response.Redirect("frmGroupDiscussion.aspx?ExerciseID=" & ExcersiseID & "&ElapsedTimeMin=" & ElapsedTimeMin & "&ElapsedTimeSec=" & ElapsedTimeSec & "&TotalTime=" & TimeAlloted & "&RspID=" & RspID & "&BandID=" & BandID & "&ExerciseType=3" & "&intLoginID=" & intLoginID)
