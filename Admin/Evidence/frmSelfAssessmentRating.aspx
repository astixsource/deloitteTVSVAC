<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster/SiteManager.master" AutoEventWireup="true" CodeFile="frmSelfAssessmentRating.aspx.cs" Inherits="frmSelfAssessmentRating" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function fnBack() {
            /*window.location.href = "frmSelfAssessmentInstruction.aspx";*/
            var bandId = $("#ConatntMatter_hdnbandId").val();
            window.location.href = "../../Data_Cohort" + bandId + "/Exercise/ExerciseMain.aspx";
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ConatntMatter" runat="Server">
    ...
    <asp:HiddenField ID="hdnRoleId" Value="0" runat="server" />
     <asp:HiddenField ID="hdnbandId" Value="0" runat="server" />
